...
export default function PMRoleView({containerState, itemState, appPrefs, onListLimitChange,
	onSearchChange, onSearchClick, onPaginationClick, onOrderBy, onOption, 
	closeModal, inputChange, goBack, session}) {

	let columns = [];
	if (itemState.prefLabels != null && itemState.prefLabels.PM_ROLE_PAGE != null) {
		columns = itemState.prefLabels.PM_ROLE_PAGE;
	}
	let group = "TABLE1";
